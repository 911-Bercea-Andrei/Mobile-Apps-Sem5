...
// facilitates the display of data in the View
class PlantsAdapter(private var plants: List<Plant>, context: Context) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlantViewHolder {
        // "false" so that it does not immediately add the item view to the layout, so we can customize it later
    ...
    override fun onBindViewHolder(holder: PlantViewHolder, position: Int) {
        ...
        holder.lastWateredTextView.text = plant.lastWatered
